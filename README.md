...
kubernetes_docker_config.yml olan ilk çalıştırılacak playbook dosyası, kubernetes cluster kurulumu, docker kurulumu ve gerekli paket yüklemelerini yapıyor.
```bash
---
